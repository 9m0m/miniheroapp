  ...
  const sheetJsx = (
    ...
    >
      <div
        ...
        tabIndex={-1}
        className="w-full max-w-md rounded-t-2xl bg-slate-900 border-t border-x border-slate-800 shadow-2xl flex flex-col max-h-[85vh] max-h-[85dvh] overflow-hidden focus:outline-none overscroll-contain pb-[max(0.5rem,env(safe-area-inset-bottom))]"
      >
        {/* Grab Handle */}
        <div className="w-12 h-1 bg-slate-700 rounded-full mx-auto mt-2 shrink-0" aria-hidden="true" />
