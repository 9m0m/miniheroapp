...
public class CraftingController {
    ...
    public ResponseEntity<ItemInstanceDto> inlayGem(@Valid @RequestBody SocketOperationRequestDto request) {
    ...
    public ResponseEntity<ItemInstanceDto> removeGem(@Valid @RequestBody SocketOperationRequestDto request) {
        return ResponseEntity.ok(craftingService.removeGem(request));
    }

    @PostMapping("/bless")
    @Operation(summary = "Ép Giấy Chúc Phúc lên trang bị")
    public ResponseEntity<ItemInstanceDto> blessItem(@Valid @RequestBody BlessRequestDto request) {
    ...
    public ResponseEntity<ItemInstanceDto> craftAccessory(@Valid @RequestBody CraftRequestDto request) {
        return ResponseEntity.ok(craftingService.craftAccessory(request));
    }

    @PostMapping("/alchemy")
    @Operation(summary = "Nấu Giấy Chúc Phúc tại Lò Giả Kim")
    public ResponseEntity<String> brewAlchemy(@Valid @RequestBody CraftRequestDto request) {
